...
\begin{paralist}
    ...
    \begin{paralist}
        ...
        \pli{Utskottsrapporter}{\info} %Informera om balen litegrann
        \pli{Ekonomisk rapport}{\info}
        \pli{Kåren informerar}{\info}
        \pli{Omvärldsrapport}{\info}
    \end{paralist}

    \pli{NollU - Transparans mot Styrelsen}{\dis}
    \pli{Äskning - Stolar Arkivet MH04 s.1}{\bes}
    \pli{Vårterminsmötet MH04 s.2-3}{\dis}
    \pli{Träffa Cedervall och ny husprefekt}{\dis}
    \pli{Styrelsedriven}{\info}
