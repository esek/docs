...
\begin{paralist}
	...
	\begin{paralist}
		\pli{Borttagandet av redaktionella organ från stadgan}{}
		\pli{Vice-poster som styrelsens suppleanter}{}
		\pli{StraffBong}{}
...
\begin{supersection}{Beslutsuppföljningar}{}
	...
	\begin{busek}
		\beslutsek{HT/17}{Veckoliga studiekvällar med tilltugg}{William Marnfeldt, Filip Larsson}{}{HT/18}
		...
		\beslutsek{VT/18}{Upprustning av bar i Edekvata}{Markus Rahne}{}{HT/18}
		\beslutsek{VT/18}{Inköp av ny tappanordning}{Markus Rahne}{}{HT/18}
		\beslutsek{VT/18}{Inköp Umphbox}{Styrelsen 2018}{}{HT/18}
		\beslutsek{VT/18}{Mikrovågsugnar}{Styrelsen 2018}{Inköp av fler Mikrovågsugnar till Edekvata}{HT/18}
		\beslutsek{VT/18}{Internationell NollEguide}{Edvard Carlsson}{}{HT/18}
	\end{busek}
	...
	\subfile{../besuppf/bar}
	\subfile{../besuppf/tapp}
	\subfile{../besuppf/umph}
	\subfile{../besuppf/micro}
	\subfile{../besuppf/nolleguide}
\end{supersection}
...
\begin{motioner}
	...
	\subfile{../motionssvar/stryka-redaktionella-organ}

	\subfile{../motioner/vice-suppleanter}
	\subfile{../motionssvar/vice-suppleanter}
