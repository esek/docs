\documentclass[10pt]{article}
    ...
    \begin{paralist}
        ...
        \pli{Äskning av pengar till inköp av kylskåp}{\bes}
        \pli{Styrelsetestamente}{\dis}
   ...
   % \emph{Beslutsuppföljningen är tom!}
    \begin{beslutsuppf}
        \beslut{S25/18}{Kassaskåp}{}{Daniel Bakic}{S27/18}
        \beslut{S25/18}{Intresse bal}{}{Axel Voss}{S27/18}
        \end{beslutsuppf}
