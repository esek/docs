\documentclass[10pt]{article}
    ...
    \begin{paralist}
        ...
        \pli{Utomstående Förtjänstmedalj}{\bes}
        \pli{Äskning av pengar till Ölresa}{\bes}
        \pli{Funktionärstack}{\dis}
        \pli{Informationsspridning}{\dis}
   ...
   % \emph{Beslutsuppföljningen är tom!}
    \begin{beslutsuppf}
    \beslut{S20/18}{Inköp flagga}{}{Magnus Lundh}{S22/18}
    \beslut{S20/18}{Inköp styrelsemärke}{}{Daniel Bakic}{S22/18}
    \end{beslutsuppf}
