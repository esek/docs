...
\begin{paralist}
    ...
    \pli{Va av mötessekreterare}{\bes}
    ...
    \begin{paralist}
        ...
        \pli{Utlandsrapport}{\info}
    \end{paralist}
    
    \pli{Äskning av pengar för inköp av funktionärsmedaljer}{\bes}
    \pli{Äskning av pengar för inköp av diverse utrustning för DrEamHackE}{\bes}		
    \pli{Kvällsmöten inför vårterminsmötet}{\dis}
