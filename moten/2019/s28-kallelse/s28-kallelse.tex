...
\begin{paralist}
    ...
    \pli{Ansökan om att bli projektfunktionär i projektet \\ Utredning om renovering av toaletterna}{\bes}
    \pli{Medaljutdelning}{\dis}
    \pli{Val av funktionärer}{\dis}
    \pli{Serveringstillstånd alla dagar i veckan}{\dis}
