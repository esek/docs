...
\begin{paralist}
    ...
    \end{paralist}
    \pli{Äskning av pengar för inköp av vattendunkar}{\bes}
    \pli{Ulla}{\bes}
    \pli{Renovering av toaletterna}{\bes}
...
\begin{beslutsuppf}
\beslut{S06/19}{Subvention vårbal}{}{Axel Voss, Emma Hjörneby, Sophia Carlsson}{S10/19}
\end{beslutsuppf}
