...
\begin{utskottsrapporter}
    \subfile{../utskottsrapporter/_exempel}
\end{utskottsrapporter}

\begin{valforslags}
    \subfile{../valforslag/_exempel-funk}
\end{valforslags}

\begin{berattelser}
    \subfile{../berattelser/_exempel}
\end{berattelser}

\begin{stadgeandringar}
    \subfile{../stadgeandringar/_exempel}
\end{stadgeandringar}

\begin{motioner}
    \subfile{../motioner/_exempel}
    \subfile{../motionssvar/_exempel}
\end{motioner}

\begin{propositioner}
    \subfile{../propositioner/_exempel}
\end{propositioner}
