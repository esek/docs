...
\begin{motioner}
    \subfile{../motioner/bananaband.tex}
    \subfile{../motionssvar/bananaband.tex}
    \subfile{../motioner/bled_cafe.tex}
    \subfile{../motionssvar/bled_cafe.tex}
    \subfile{../motioner/cm_pump.tex}
    \subfile{../motionssvar/cm_pump.tex}
    \subfile{../motioner/examenstavlor.tex}
    \subfile{../motionssvar/examenstavlor.tex}
    \subfile{../motioner/inspektorskladsel.tex}
    \subfile{../motionssvar/inspektorskladsel.tex}
\end{motioner}
