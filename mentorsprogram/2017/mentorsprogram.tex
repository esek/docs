...
\def\date{2017-05-08} %YYYY-MM-DD
...
% Kultur inom sektionen? "bara tentan" - Ingrid
% Lägga till något om Johan utb. lv.0
% Planera med Johan
% Balans
% Första träffen gem? + ytterligare en träff
% Minska pressen på BME, för höga ambitioner?
% Viktigaste i övertygan - identifikation, viktigt med E-E, BME-BME?
% Skriv om slappare krav på mentor (min. årskurs)
% "Man är ingen teknolog förens man kuggat sin första tenta"
% "Det finns omtentor men inga omfester"
% Johan utvärdering
% Ingrid utvärderingsverktyg
...
\begin{document}
    ...
    % Ändra till att Johan utbildar istället
    % 2h utb.

    % Johan:
    % - Lära sig ställa (rätt) frågor <--
    % - Mätbara, konkreta, rimliga målsättningar
    % - ------
    % - Lära adepten att skilja på plugg och privatliv
    % - Grit ("jävla anamma"),
    %   det handlar mer om vilja och ansträngning än talang
    % - Growth mindset (hur man förhåller sig till sin egen intelligens,
    %   är den statisk eller kan den växa?)
