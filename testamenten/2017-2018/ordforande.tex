...
\def\post{Ordförande}
\def\date{2017-11-26} %YYYY-MM-DD
...
Tänk på att synas mycket under nollningen och gå på så många aktiviteter som du kan. Tagga även styrelsen att gå på mycket. Ju mer ni syns, desto bättre. Ni kan till exempel spexa under sittningar, hjälpa till att laga mat. Det finns en budget för representation av styrelsen som syftar till att bidra med sittningskostnader för styrelsemedlemmar (dock ingen alkohol).
