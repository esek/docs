\documentclass[11pt]{article}
    ...
    \def\date{2018}
    \def\doctitle{Packlista för gästande Styrelser}
    ...
    \begin{document}
        ...
        \begin{multicols}{2}
            ...
            \begin{itemize}
                ...
                \item Bastukläder
                \item Handduk
                \item \small{Styrelsespecifik utstyrsel}
                \item Sångbok
                \item Alkohol \tiny{(finns möjlighet att gå till systemet på fredag em.)}
                \item \normalsize{Teknologmössa}
            \end{itemize}}
            \end{multicols}
